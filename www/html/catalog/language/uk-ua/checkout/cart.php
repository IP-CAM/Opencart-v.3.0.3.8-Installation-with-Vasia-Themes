...
$_['text_month'] = 'місяць';
$_['text_year'] = 'рік';
$_['text_trial'] = ': %s; Періодичність: %s %s; Кількість платежів: %s; Далі, ';$_['text_recurring'] = ': %s; Періодичність: %s %s';
...
$_['text_payment_cancel']      = '%s Періодичність %d %s(s) Кількість платежів: до скасування';
